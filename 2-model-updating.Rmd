...
mdl_vars12 <- mdl_vars12[! mdl_vars12 %in% c('cre12')] # Remove highly correlated variables
mdl_vars12
...
```{r}
conf_matrix(plot_data12$out, plot_data12$prob, 0.4, mdl_folder12, "conf_matrix.txt")
```
...
mdl_vars34 <- mdl_vars34[! mdl_vars34 %in% c('cre34', 'crp34')] # Remove highly correlated variables
#mdl_vars34
...
```{r}
conf_matrix(plot_data34$out, plot_data34$prob, 0.5, mdl_folder34, "conf_matrix.txt")
```
