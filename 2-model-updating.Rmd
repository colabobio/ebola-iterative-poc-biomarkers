...
* Use different day blocks (e.g.: 1-2, 3-6)
...
#cov12 <- cov(data12)
#cov12 <- cor(na.omit(data12))
cov12 <- cor(data12 ,use='pairwise')
cov12
...
mdl_vars12 <- c('ck12', 'alt12', 'bun12', 'k12', 'alb12', 'lp0')
mdl_vars12
...
mdl_vars34 <- c('cre34', 'alb34', 'k34', 'lp12')
mdl_vars34
