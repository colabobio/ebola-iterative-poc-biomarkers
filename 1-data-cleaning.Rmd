...
```{r}
# Variable selection
test_days <- c('.D1', '.D2', '.D3', '.D4', '.D5', '.D6', '.D7')

df_1to7 <- df_raw %>% select(ends_with(test_days))
df_labs <- df_1to7 %>% select(starts_with(lab_vars))
...
# More than 7th sample is not needed, very few have data for the first 6 day of hospital stay (only 6 in 8th sample)
```

```{r}
# Transform K so both extremes (low and high) map to high values

k_vars <- c('Lab.AmLyteK.D1', 'Lab.AmLyteK.D2', 'Lab.AmLyteK.D3', 'Lab.AmLyteK.D4', 'Lab.AmLyteK.D5', 'Lab.AmLyteK.D6', 'Lab.AmLyteK.D7')
...
alb_vars <- c('Lab.AmLyteALB.D1', 'Lab.AmLyteALB.D2', 'Lab.AmLyteALB.D3', 'Lab.AmLyteALB.D4', 'Lab.AmLyteALB.D5', 'Lab.AmLyteALB.D6', 'Lab.AmLyteALB.D7')
...
# Use as very large, positive value for min calculations to work (otherwise NA always gets picked by max)
df_labs[is.na(df_labs)] <- +10000
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F1 <- pmin(df_labs$Lab.CtNP.F11, df_labs$Lab.CtNP.F12, 
                            df_labs$Lab.CtNP.F13, df_labs$Lab.CtNP.F14,
                            df_labs$Lab.CtNP.F15, df_labs$Lab.CtNP.F16, df_labs$Lab.CtNP.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F2 <- pmin(df_labs$Lab.CtNP.F21, df_labs$Lab.CtNP.F22, 
                            df_labs$Lab.CtNP.F23, df_labs$Lab.CtNP.F24,
                            df_labs$Lab.CtNP.F25, df_labs$Lab.CtNP.F26, df_labs$Lab.CtNP.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F3 <- pmin(df_labs$Lab.CtNP.F31, df_labs$Lab.CtNP.F32, 
                            df_labs$Lab.CtNP.F33, df_labs$Lab.CtNP.F34,
                            df_labs$Lab.CtNP.F35, df_labs$Lab.CtNP.F36, df_labs$Lab.CtNP.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F4 <- pmin(df_labs$Lab.CtNP.F41, df_labs$Lab.CtNP.F42, 
                            df_labs$Lab.CtNP.F43, df_labs$Lab.CtNP.F44,
                            df_labs$Lab.CtNP.F45, df_labs$Lab.CtNP.F46, df_labs$Lab.CtNP.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F5 <- pmin(df_labs$Lab.CtNP.F51, df_labs$Lab.CtNP.F52, 
                            df_labs$Lab.CtNP.F53, df_labs$Lab.CtNP.F54,
                            df_labs$Lab.CtNP.F55, df_labs$Lab.CtNP.F56, df_labs$Lab.CtNP.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.CtNP.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.CtNP.D7, +10000))
df_labs$Lab.CtNP.F6 <- pmin(df_labs$Lab.CtNP.F61, df_labs$Lab.CtNP.F62, 
                            df_labs$Lab.CtNP.F63, df_labs$Lab.CtNP.F64,
                            df_labs$Lab.CtNP.F65, df_labs$Lab.CtNP.F66, df_labs$Lab.CtNP.F67)
...
```{r}
# Use as very large, negative value for max calculations to work (otherwise NA always gets picked by max)
df_labs[is.na(df_labs)] <- -10000
```
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F1 <- pmax(df_labs$Lab.AmLyteBUN.F11, df_labs$Lab.AmLyteBUN.F12, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F15, df_labs$Lab.AmLyteBUN.F16, df_labs$Lab.AmLyteBUN.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F2 <- pmax(df_labs$Lab.AmLyteBUN.F21, df_labs$Lab.AmLyteBUN.F22, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F25, df_labs$Lab.AmLyteBUN.F26, df_labs$Lab.AmLyteBUN.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F3 <- pmax(df_labs$Lab.AmLyteBUN.F31, df_labs$Lab.AmLyteBUN.F32, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F35, df_labs$Lab.AmLyteBUN.F36, df_labs$Lab.AmLyteBUN.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F4 <- pmax(df_labs$Lab.AmLyteBUN.F41, df_labs$Lab.AmLyteBUN.F42, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F45, df_labs$Lab.AmLyteBUN.F46, df_labs$Lab.AmLyteBUN.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F5 <- pmax(df_labs$Lab.AmLyteBUN.F51, df_labs$Lab.AmLyteBUN.F52, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F55, df_labs$Lab.AmLyteBUN.F56, df_labs$Lab.AmLyteBUN.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteBUN.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteBUN.D7, -10000))
df_labs$Lab.AmLyteBUN.F6 <- pmax(df_labs$Lab.AmLyteBUN.F61, df_labs$Lab.AmLyteBUN.F62, 
                                 ...
                                 df_labs$Lab.AmLyteBUN.F65, df_labs$Lab.AmLyteBUN.F66, df_labs$Lab.AmLyteBUN.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F1 <- pmax(df_labs$Lab.AmLyteALT.F11, df_labs$Lab.AmLyteALT.F12, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F15, df_labs$Lab.AmLyteALT.F16, df_labs$Lab.AmLyteALT.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F2 <- pmax(df_labs$Lab.AmLyteALT.F21, df_labs$Lab.AmLyteALT.F22, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F25, df_labs$Lab.AmLyteALT.F26, df_labs$Lab.AmLyteALT.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F3 <- pmax(df_labs$Lab.AmLyteALT.F31, df_labs$Lab.AmLyteALT.F32, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F35, df_labs$Lab.AmLyteALT.F36, df_labs$Lab.AmLyteALT.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F4 <- pmax(df_labs$Lab.AmLyteALT.F41, df_labs$Lab.AmLyteALT.F42, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F45, df_labs$Lab.AmLyteALT.F46, df_labs$Lab.AmLyteALT.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F5 <- pmax(df_labs$Lab.AmLyteALT.F51, df_labs$Lab.AmLyteALT.F52, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F55, df_labs$Lab.AmLyteALT.F56, df_labs$Lab.AmLyteALT.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALT.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteALT.D7, -10000))
df_labs$Lab.AmLyteALT.F6 <- pmax(df_labs$Lab.AmLyteALT.F61, df_labs$Lab.AmLyteALT.F62, 
                                 ...
                                 df_labs$Lab.AmLyteALT.F65, df_labs$Lab.AmLyteALT.F66, df_labs$Lab.AmLyteALT.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F1 <- pmax(df_labs$Lab.AmLyteAST.F11, df_labs$Lab.AmLyteAST.F12, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F15, df_labs$Lab.AmLyteAST.F16, df_labs$Lab.AmLyteAST.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F2 <- pmax(df_labs$Lab.AmLyteAST.F21, df_labs$Lab.AmLyteAST.F22, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F25, df_labs$Lab.AmLyteAST.F26, df_labs$Lab.AmLyteAST.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F3 <- pmax(df_labs$Lab.AmLyteAST.F31, df_labs$Lab.AmLyteAST.F32, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F35, df_labs$Lab.AmLyteAST.F36, df_labs$Lab.AmLyteAST.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F4 <- pmax(df_labs$Lab.AmLyteAST.F41, df_labs$Lab.AmLyteAST.F42, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F45, df_labs$Lab.AmLyteAST.F46, df_labs$Lab.AmLyteAST.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F5 <- pmax(df_labs$Lab.AmLyteAST.F51, df_labs$Lab.AmLyteAST.F52, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F55, df_labs$Lab.AmLyteAST.F56, df_labs$Lab.AmLyteAST.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteAST.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteAST.D7, -10000))
df_labs$Lab.AmLyteAST.F6 <- pmax(df_labs$Lab.AmLyteAST.F61, df_labs$Lab.AmLyteAST.F62, 
                                 ...
                                 df_labs$Lab.AmLyteAST.F65, df_labs$Lab.AmLyteAST.F66, df_labs$Lab.AmLyteAST.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F1 <- pmax(df_labs$Lab.AmLyteCK.F11, df_labs$Lab.AmLyteCK.F12, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F15, df_labs$Lab.AmLyteCK.F16, df_labs$Lab.AmLyteCK.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F2 <- pmax(df_labs$Lab.AmLyteCK.F21, df_labs$Lab.AmLyteCK.F22, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F25, df_labs$Lab.AmLyteCK.F26, df_labs$Lab.AmLyteCK.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F3 <- pmax(df_labs$Lab.AmLyteCK.F31, df_labs$Lab.AmLyteCK.F32, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F35, df_labs$Lab.AmLyteCK.F36, df_labs$Lab.AmLyteCK.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F4 <- pmax(df_labs$Lab.AmLyteCK.F41, df_labs$Lab.AmLyteCK.F42, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F45, df_labs$Lab.AmLyteCK.F46, df_labs$Lab.AmLyteCK.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F5 <- pmax(df_labs$Lab.AmLyteCK.F51, df_labs$Lab.AmLyteCK.F52, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F55, df_labs$Lab.AmLyteCK.F56, df_labs$Lab.AmLyteCK.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCK.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteCK.D7, -10000))
df_labs$Lab.AmLyteCK.F6 <- pmax(df_labs$Lab.AmLyteCK.F61, df_labs$Lab.AmLyteCK.F62, 
                                 ...
                                 df_labs$Lab.AmLyteCK.F65, df_labs$Lab.AmLyteCK.F66, df_labs$Lab.AmLyteCK.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F1 <- pmax(df_labs$Lab.AmLyteALB.F11, df_labs$Lab.AmLyteALB.F12, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F15, df_labs$Lab.AmLyteALB.F16, df_labs$Lab.AmLyteALB.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F2 <- pmax(df_labs$Lab.AmLyteALB.F21, df_labs$Lab.AmLyteALB.F22, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F25, df_labs$Lab.AmLyteALB.F26, df_labs$Lab.AmLyteALB.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F3 <- pmax(df_labs$Lab.AmLyteALB.F31, df_labs$Lab.AmLyteALB.F32, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F35, df_labs$Lab.AmLyteALB.F36, df_labs$Lab.AmLyteALB.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F4 <- pmax(df_labs$Lab.AmLyteALB.F41, df_labs$Lab.AmLyteALB.F42, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F45, df_labs$Lab.AmLyteALB.F46, df_labs$Lab.AmLyteALB.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F5 <- pmax(df_labs$Lab.AmLyteALB.F51, df_labs$Lab.AmLyteALB.F52, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F55, df_labs$Lab.AmLyteALB.F56, df_labs$Lab.AmLyteALB.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteALB.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteALB.D7, -10000))
df_labs$Lab.AmLyteALB.F6 <- pmax(df_labs$Lab.AmLyteALB.F61, df_labs$Lab.AmLyteALB.F62, 
                                 ...
                                 df_labs$Lab.AmLyteALB.F65, df_labs$Lab.AmLyteALB.F66, df_labs$Lab.AmLyteALB.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F1 <- pmax(df_labs$Lab.AmLyteK.F11, df_labs$Lab.AmLyteK.F12, 
                                 ...
                                 df_labs$Lab.AmLyteK.F15, df_labs$Lab.AmLyteK.F16, df_labs$Lab.AmLyteK.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F2 <- pmax(df_labs$Lab.AmLyteK.F21, df_labs$Lab.AmLyteK.F22, 
                                 ...
                                 df_labs$Lab.AmLyteK.F25, df_labs$Lab.AmLyteK.F26, df_labs$Lab.AmLyteK.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F3 <- pmax(df_labs$Lab.AmLyteK.F31, df_labs$Lab.AmLyteK.F32, 
                                 ...
                                 df_labs$Lab.AmLyteK.F35, df_labs$Lab.AmLyteK.F36, df_labs$Lab.AmLyteK.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F4 <- pmax(df_labs$Lab.AmLyteK.F41, df_labs$Lab.AmLyteK.F42, 
                                 ...
                                 df_labs$Lab.AmLyteK.F45, df_labs$Lab.AmLyteK.F46, df_labs$Lab.AmLyteK.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F5 <- pmax(df_labs$Lab.AmLyteK.F51, df_labs$Lab.AmLyteK.F52, 
                                 ...
                                 df_labs$Lab.AmLyteK.F55, df_labs$Lab.AmLyteK.F56, df_labs$Lab.AmLyteK.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteK.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteK.D7, -10000))
df_labs$Lab.AmLyteK.F6 <- pmax(df_labs$Lab.AmLyteK.F61, df_labs$Lab.AmLyteK.F62, 
                                 ...
                                 df_labs$Lab.AmLyteK.F65, df_labs$Lab.AmLyteK.F66, df_labs$Lab.AmLyteK.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F1 <- pmax(df_labs$Lab.AmLyteCRE.F11, df_labs$Lab.AmLyteCRE.F12, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F15, df_labs$Lab.AmLyteCRE.F16, df_labs$Lab.AmLyteCRE.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F2 <- pmax(df_labs$Lab.AmLyteCRE.F21, df_labs$Lab.AmLyteCRE.F22, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F25, df_labs$Lab.AmLyteCRE.F26, df_labs$Lab.AmLyteCRE.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F3 <- pmax(df_labs$Lab.AmLyteCRE.F31, df_labs$Lab.AmLyteCRE.F32, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F35, df_labs$Lab.AmLyteCRE.F36, df_labs$Lab.AmLyteCRE.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F4 <- pmax(df_labs$Lab.AmLyteCRE.F41, df_labs$Lab.AmLyteCRE.F42, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F45, df_labs$Lab.AmLyteCRE.F46, df_labs$Lab.AmLyteCRE.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F5 <- pmax(df_labs$Lab.AmLyteCRE.F51, df_labs$Lab.AmLyteCRE.F52, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F55, df_labs$Lab.AmLyteCRE.F56, df_labs$Lab.AmLyteCRE.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRE.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteCRE.D7, -10000))
df_labs$Lab.AmLyteCRE.F6 <- pmax(df_labs$Lab.AmLyteCRE.F61, df_labs$Lab.AmLyteCRE.F62, 
                                 ...
                                 df_labs$Lab.AmLyteCRE.F65, df_labs$Lab.AmLyteCRE.F66, df_labs$Lab.AmLyteCRE.F67)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F17 = ifelse(-1 <= Lab.SampleDiff.D7 & Lab.SampleDiff.D7 <= 1, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F1 <- pmax(df_labs$Lab.AmLyteCRP.F11, df_labs$Lab.AmLyteCRP.F12, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F15, df_labs$Lab.AmLyteCRP.F16, df_labs$Lab.AmLyteCRP.F17)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F27 = ifelse(Lab.SampleDiff.D7 == 2, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F2 <- pmax(df_labs$Lab.AmLyteCRP.F21, df_labs$Lab.AmLyteCRP.F22, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F25, df_labs$Lab.AmLyteCRP.F26, df_labs$Lab.AmLyteCRP.F27)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F37 = ifelse(Lab.SampleDiff.D7 == 3, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F3 <- pmax(df_labs$Lab.AmLyteCRP.F31, df_labs$Lab.AmLyteCRP.F32, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F35, df_labs$Lab.AmLyteCRP.F36, df_labs$Lab.AmLyteCRP.F37)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F47 = ifelse(Lab.SampleDiff.D7 == 4, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F4 <- pmax(df_labs$Lab.AmLyteCRP.F41, df_labs$Lab.AmLyteCRP.F42, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F45, df_labs$Lab.AmLyteCRP.F46, df_labs$Lab.AmLyteCRP.F47)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F57 = ifelse(Lab.SampleDiff.D7 == 5, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F5 <- pmax(df_labs$Lab.AmLyteCRP.F51, df_labs$Lab.AmLyteCRP.F52, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F55, df_labs$Lab.AmLyteCRP.F56, df_labs$Lab.AmLyteCRP.F57)
...
df_labs <- df_labs %>% 
  mutate(Lab.AmLyteCRP.F67 = ifelse(Lab.SampleDiff.D7 == 6, Lab.AmLyteCRP.D7, -10000))
df_labs$Lab.AmLyteCRP.F6 <- pmax(df_labs$Lab.AmLyteCRP.F61, df_labs$Lab.AmLyteCRP.F62, 
                                 ...
                                 df_labs$Lab.AmLyteCRP.F65, df_labs$Lab.AmLyteCRP.F66, df_labs$Lab.AmLyteCRP.F67)
