...
```{r}
# Variable selection
test_days <- c('.D1', '.D2', '.D3', '.D4', '.D5', '.D6', '.D7', '.D8')
...
k_vars <- c('Lab.AmLyteK.D1', 'Lab.AmLyteK.D2', 'Lab.AmLyteK.D3', 'Lab.AmLyteK.D4', 'Lab.AmLyteK.D5', 'Lab.AmLyteK.D6', 'Lab.AmLyteK.D7', 'Lab.AmLyteK.D8')
...
alb_vars <- c('Lab.AmLyteALB.D1', 'Lab.AmLyteALB.D2', 'Lab.AmLyteALB.D3', 'Lab.AmLyteALB.D4', 'Lab.AmLyteALB.D5', 'Lab.AmLyteALB.D6', 'Lab.AmLyteALB.D7', 'Lab.AmLyteALB.D8')
...
# Go over all lab variables and collect the results correspondong to each day after admission
for (var in lab_vars) {
  print(var)
  ...
  day_vars <- paste0(paste0(var, '.D'), 1:8)
  sample_vars <- paste0(paste0("Lab.SampleDiff", '.D'), 1:8)
  for (d in 1:8) {
    final_var <- paste0(var, '.F', d)
    diff_vars <- paste0(paste0(var, '.F', d), 1:8)
    for (f in 1:8) {
      diffv <- diff_vars[f]
